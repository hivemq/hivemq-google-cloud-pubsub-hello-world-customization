...
. Move the `build/libs/hivemq-google-cloud-pubsub-hello-world-customization-4.36.0.jar` file to the  `HIVEMQ_HOME/extensions/hivemq-google-cloud-pubsub-extension/customizations` directory.
